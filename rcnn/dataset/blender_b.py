...
class Blender_b(IMDB):
    def __init__(self, image_set, root_path, dataset_path):
        ...
        """
        super(Blender_b, self).__init__('blender_b', image_set, root_path, dataset_path)

        self.classes = dataset.Blender_b.CLASSES
        self.class_id = dataset.Blender_b.CLASS_ID
        self.num_classes = dataset.Blender_b.NUM_CLASSES
...
if __name__ == '__main__':
    bl = Blender_b(image_set='test_03', root_path='', dataset_path='/home/sliay/mx-maskrcnn/data/blender_b')
    bl.gt_roidb()
    bl.visualize_box()
